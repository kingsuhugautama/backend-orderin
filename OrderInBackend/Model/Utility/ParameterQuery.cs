...
namespace OrderInBackend.Model.Utility
{
    ...
    {
        public int p_limit { get; set; }
        public int p_offset { get; set; }
    
    }

    public class ParameterQuery
    {
        public static string GetQueryFiltersByParams(List<Model.ParameterSearchModel> param, bool withOr = false)
        {
        ...
        public static ParameterLimit GetLimitOffset(int page = 1,int limit = 10)
        {
            return new ParameterLimit
            {
                p_limit = limit,
                p_offset = limit * (page - 1) //offset dimulai dari 0, jika diset page 1 maka offsetnya 0
            };
        }
    }
}
